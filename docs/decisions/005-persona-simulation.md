...
- **Future work:** Claude/Anthropic SDK support as an alternative LLM provider. UI for triggering and reviewing simulation runs. Automated scoring/evaluation of simulation transcripts.
